...
(
    ...
    notice_range   char(1)      default null comment '通知范围（0不限制 1机构 2角色）',
    date_range     longblob     default null comment '时间范围(例如 2024-01-01,2024-02-29)',
    range_data     longblob     default null comment '范围数据',
    create_by      varchar(64)  default '' comment '创建者',
    create_time    datetime comment '创建时间',
    update_by      varchar(64)  default '' comment '更新者',
    update_time    datetime comment '更新时间',
